...
Este documento resume qué cambia en **Prueba 13** respecto a entregas anteriores del repositorio, además de incluir instrucciones de ejecución, pruebas y resolución de problemas.

## Resumen rápido

Prueba 13 refina la gestión de ventanas (1/4, 1/2 y pantalla completa), mejora la selección y asignación de medios para ventanas de fondo y corrige problemas de UX relacionados con el selector de archivos y la posición de la ventana principal.
...
A continuación se describen las diferencias más relevantes frente a versiones previas (Prueba 6..Prueba 12):
...
- "Selecciono Mitad Derecha y siempre se abre en la Izquierda":
    ...
    - Si `position` enviado en el evento IPC no coincide con `mainPosition`, informar aquí y adjuntar los logs.
